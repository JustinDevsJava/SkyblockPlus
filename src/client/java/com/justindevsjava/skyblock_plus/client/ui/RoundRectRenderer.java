...
public class RoundRectRenderer extends PictureInPictureRenderer<RoundRectRenderer.State> {
    ...
    protected void renderToTexture(State state, PoseStack poseStack) {
        ...
        GpuBuffer vertexBuffer = SkyblockPlusRenderTypes.PIPELINE_ROUND_RECT.getVertexFormat().uploadImmediateVertexBuffer(mesh.vertexBuffer());
        ...
        try (
                ...
                RenderPass pass = RenderSystem.getDevice().createCommandEncoder().createRenderPass(
                        () -> "Skyblock+ Rounded Rectangle Render Pass",
            ...
            pass.setPipeline(SkyblockPlusRenderTypes.PIPELINE_ROUND_RECT);
    ...
    protected @NotNull String getTextureLabel() {
        return "Skyblock+ Rounded Rectangle PIP";
    }
    ...
    public static class Uniform {
        ...
        private static final DynamicUniformStorage<DynamicUniformStorage.DynamicUniform> STORAGE =
                new DynamicUniformStorage<>("Skyblock+ Rounded Rectangle UBO", SIZE, 4);
